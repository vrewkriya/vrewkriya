export function getAutoReplyEmailTemplate(firstName: string, brand: string, service: string, message: string, phone?: string) {
  ...
  return `
    ...
    <head>
      ...
      <title>Vrewkriya - We Got You</title>
      <style>
    ...
    <body>
      <div class="email-wrapper">
        ...
        ${phone ? `
        <div class="body-content" style="padding-top: 0; border-top: 0;">
          <p style="margin-top: 0;">
            We&apos;ll use this number if we need to reach you quickly: <span class="highlight">${phone}</span>.
          </p>
        </div>
        ` : ""}
        ...
        <div class="body-content">
          ...
          <p>
            Your inquiry for <span class="highlight">${service}</span> has been received and our team is already diving into your details. This is exactly the kind of challenge we live for.
          </p>
        ...
        <div class="footer">
          ...
          <div class="footer-copy">
            Copyright ${new Date().getFullYear()} Vrewkriya. All rights reserved.<br/>
